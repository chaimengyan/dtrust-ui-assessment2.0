...
export default {
    ...
    data() {
      return {
        ...
        title: '聊天框',
        size: {},
        rect: { width: props.defaultWidth, height: props.defaultHeight, left: 0, top: 0 },
// 记录实时大小信息，用来判断是否可以拖拽放大缩小
    ...
    created() {
        ...
        useDarg('#QuestionModal .question-header', '#QuestionModal .question-modal-content', (x, y) => {
        ...
        useDarg('#QuestionModal .point.p1', null, p1, () => !this.fixed, this.resetRect);
        useDarg('#QuestionModal .point.p2', null, p2, () => !this.fixed, this.resetRect);
        useDarg('#QuestionModal .point.p3', null, p3, () => !this.fixed, this.resetRect);

        useDarg('#QuestionModal .line.l1', null, l1, () => !this.fixed, this.resetRect);
        useDarg('#QuestionModal .line.l2', null, l2, () => !this.fixed, this.resetRect);
        useDarg('#QuestionModal .line.l3', null, l3, () => true, this.resetRect);
    },
    computed: {
      rectStyle() {
        return {
    ...
    methods: {
      ...
      setSize() {
        this.size = {
          maxWidth: this.hasPercentage(this.maxWidth) ? this.cale(this.maxWidth) : this.parseInt(this.maxWidth),
          minWidth: this.hasPercentage(this.minWidth) ? this.cale(this.minWidth) : this.parseInt(this.minWidth),
          maxHeight: this.hasPercentage(this.maxHeight) ? this.cale(this.maxHeight, false) : this.parseInt(this.maxHeight),
          minHeight: this.hasPercentage(this.minHeight) ? this.cale(this.minHeight, false) : this.parseInt(this.minHeight),
          containerMinWidth: this.hasPercentage(this.containerMinWidth) ? this.cale(this.containerMinWidth) : this.parseInt(this.containerMinWidth),
        }
      },
      ...
      cale(value, isWidth) {
        ...
        return docVal * (this.parseInt(v) / 100)
      },
      ...
      getDefaultSize() {
        ...
        return {
          left: width - this.defaultWidth - 20,
          top: height - this.defaultHeight - 20,
          width: this.defaultWidth,
      ...
      setRect(data) {
        this.rect = data;
        Object.assign(this.r, { ...this.data })
      },
