<template>
        ...
        >
          ...
          <template slot="menu" slot-scope="scope">
            <el-tooltip class="item" effect="dark" :content="$t('crudCommon.编辑')" placement="top">
              <el-button
                v-if="permissions.field_dataClassification_edit"
                type="text"
                icon="el-icon-edit"
            ...
            <el-tooltip class="item" effect="dark" :content="$t('crudCommon.删除')" placement="top">
              <el-button
                v-if="permissions.field_dataClassification_del"
                type="text"
                icon="el-icon-delete"
  ...
  import {
    addObj,
    delObj,
    getAssetsTableByPage,
    putObj,
  } from "@/api/customConfiguration/tableConfiguration/index";
  import { tableOption } from "@/const/crud/customConfiguration/tableConfiguration/index";
  ...
  export default {
    ...
    methods: {
      ...
      selectionChange(list){
        this.ids = list.map(item => (item.tableId))
      },
  
      deleteBtn(row) {
        const ids = row ? [row.tableId] : this.ids
        if(!ids.length) {
